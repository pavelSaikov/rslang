...
export const MAX_NEW_WORDS_PER_GAME = 10;
export const MAX_LEARNED_WORDS_PER_GAME = 0;
...
export const SETTINGS = [
  { option: 'Translation Visibility', action: setIsTranslationVisible, name: 'isTranslationVisible' },
  {
    option: 'Example Sentence Translation Visibility',
    action: setIsExampleSentenceTranslationVisible,
    name: 'isExampleSentenceTranslationVisible',
  },
  {
    option: 'Description Sentence Translation Visibility',
